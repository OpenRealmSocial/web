...
export function openrealmNetworkFromJSON(object: any): OpenrealmNetwork {
  switch (object) {
    case 0:
    case "OPENREALM_NETWORK_NONE":
      return OpenrealmNetwork.NONE;
    case 1:
    case "OPENREALM_NETWORK_MAINNET":
      return OpenrealmNetwork.MAINNET;
    case 2:
    case "OPENREALM_NETWORK_TESTNET":
      return OpenrealmNetwork.TESTNET;
    case 3:
    case "OPENREALM_NETWORK_DEVNET":
      return OpenrealmNetwork.DEVNET;
    default:
      throw new tsProtoGlobalThis.Error("Unrecognized enum value " + object + " for enum OpenrealmNetwork");
  }
}

export function openrealmNetworkToJSON(object: OpenrealmNetwork): string {
  switch (object) {
    case OpenrealmNetwork.NONE:
      return "OPENREALM_NETWORK_NONE";
    case OpenrealmNetwork.MAINNET:
      return "OPENREALM_NETWORK_MAINNET";
    case OpenrealmNetwork.TESTNET:
      return "OPENREALM_NETWORK_TESTNET";
    case OpenrealmNetwork.DEVNET:
      return "OPENREALM_NETWORK_DEVNET";
    default:
      throw new tsProtoGlobalThis.Error("Unrecognized enum value " + object + " for enum OpenrealmNetwork");
  }
}
...
export const MessageData = {
  encode(message: MessageData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.qid !== 0) {
      writer.uint32(16).uint64(message.qid);
    }
  ...
  fromJSON(object: any): MessageData {
    return {
      ...
      network: isSet(object.network) ? openrealmNetworkFromJSON(object.network) : 0,
  ...
  toJSON(message: MessageData): unknown {
    ...
    message.network !== undefined && (obj.network = openrealmNetworkToJSON(message.network));
...
function createBaseCastId(): CastId {
  return { qid: 0, hash: new Uint8Array() };
}
...
function createBaseLinkBody(): LinkBody {
  return { type: "", displayTimestamp: undefined, targetQid: undefined };
}
